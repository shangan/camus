...
public class MTCamusJob extends CamusJob {
  ...
  private ZkClient createZkClient() throws IOException {
    ...
    int sessionTimeout = Integer.valueOf(localProps.getProperty(Configuration.ZOOKEEPER_SESSION_TIMEOUT, "15000"));
    int connectTimeout = Integer.valueOf(localProps.getProperty(Configuration.ZOOKEEPER_CONNECT_TIMEOUT, "15000"));
